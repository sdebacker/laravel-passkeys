...
class PasskeyFactory extends Factory
{
    ...
    public function definition()
    {
        ...
        return [
            ...
            'data' => $this->dummyCredentialRecord(),
        ];
    }

    protected function dummyCredentialRecord(): CredentialRecord
    {
        return new CredentialRecord(
            publicKeyCredentialId: base64_decode(
            ...
            credentialPublicKey: base64_decode(
